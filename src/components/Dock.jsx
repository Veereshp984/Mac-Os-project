...
const Dock = ({ setwindowsState }) => {
  return (
    <footer className="dock">
      ...
      <div
       onClick={() => {
        window.open("https://mail.google.com/mail/?view=cm&fs=1&to=pasaveeresh0908@gmail.com", "_blank");
       }}
      className="icon mail">
        <img src="/doc-icons/mail.svg" alt="" />
      </div>
      <div
      onClick={()=>{window.open("https://www.linkedin.com/in/veeresh-pasare" , "_blank")}}
      className="icon link">
